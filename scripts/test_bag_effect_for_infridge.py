...
def plot_difference_bagvsnot_img_feature(criteria=criteria):
    ...
    for criterion in criteria:
        ...
        plt.legend()
        plt.savefig(f'plots/hist_delta_fridged_{criterion}.png', bbox_inches='tight')
        plt.close()

def bagvsnot_test_img_feature(criteria=criteria):
    '''
...
def plot_difference_bagvsnot_weight():
    ...
    plt.legend()
    plt.savefig('plots/hist_delta_fridged_weight.png', bbox_inches='tight')
    plt.close()

def bagvsnot_test_weight():
    '''
    ...
    plt.axvline(x=output['max_mean_dif_observe'], label='Observed', color='salmon')
    plt.legend()
    plt.savefig(f'plots/mean_dif_test_weights_baggedvsnot.png', bbox_inches='tight')
    plt.close()
